...
\IEEEPARstart{T}{his} project will create an automated NERF turret that can detect a target \colorbox{yellow}{(a human face)}, aim, and fire at the target. The project will model the detection of a target and aiming as a state machine governed by the combination of RGBD camera data and other sensor inputs to correctly \colorbox{yellow}{rotate the turret and incline the NERF gun to aim at the target}. The goal will be to accurately detect a target and aim/fire accurately for maximum effect.

\section{Project Requirements}

\itemize{
\item
Turret platform support rotation up to 360 degree.
\item
Turret gun support incline angle between 0 and 30 degree.
\item
...
Updates on the controller for the turret + figure showing state 
