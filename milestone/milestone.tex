...
\IEEEPARstart{T}{his} project will create an automated NERF turret that can detect a target (a human face), aim, and fire at the target. The project will model the detection of a target and aiming as a state machine governed by the combination of RGBD camera data and other sensor inputs to correctly aim the turret. The goal will be to accurately detect a target and aim/fire accurately for maximum effect.
